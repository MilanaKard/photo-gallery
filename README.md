...
6. Можно переключать фото внутри альбома по стрелкам, не покидая всплывающего окна.
